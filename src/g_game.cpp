...
void G_Ticker ()
{
	...
	while (gameaction != ga_nothing)
	{
		...
		case ga_autoloadgame:
			...
			break;
		case ga_savegame:
			G_DoSaveGame (doquicksave, false, savegamefile, savedescription.GetChars());
		...
		case ga_quicksave:
			doquicksave = true;
			G_DoSaveGame(doquicksave, true, savegamefile, savedescription.GetChars());
			gameaction = ga_nothing;
			savegamefile = "";
			savedescription = "";
			break;
...
void G_DoLoadGame ()
{
	...
	if (longsavemessages) Printf("%s (%s)\n", GStrings.GetString("GGLOADED"), savename.GetChars());
	else Printf("%s\n", GStrings.GetString("GGLOADED"));
...
void G_DoAutoSave ()
{
	...
	G_DoSaveGame (doquicksave, false, file, description.GetChars());
}
