...
CUSTOM_CVAR(Int, compatmode, 0, CVAR_ARCHIVE|CVAR_NOINITCALL)
{
	...
	case 2:	// same as 1 but stricter (NO_PASSMOBJ and INVISIBILITY are also set)
		...
		w = COMPATF2_BADANGLES | COMPATF2_FLOORMOVE | COMPATF2_POINTONLINE | COMPATF2_EXPLODE2 | COMPATF2_NOMBF21 | COMPATF2_VOODOO_ZOMBIES | COMPATF2_OLD_RANDOM_GENERATOR | COMPATF2_EMULATEMIKOPORTALS;
		break;
	...
	case 9: // Stricter MBF21 compatibility
		...
		w = COMPATF2_POINTONLINE | COMPATF2_EXPLODE1 | COMPATF2_EXPLODE2 | COMPATF2_AVOID_HAZARDS | COMPATF2_STAYONLIFT | COMPATF2_EMULATEMIKOPORTALS;
		break;
	}
	compatflags = v;
	compatflags2 = w;
