...
CUSTOM_CVAR(Int, compatmode, 0, CVAR_ARCHIVE|CVAR_NOINITCALL)
{
	...
	case 1:	// Doom2.exe compatible with a few relaxed settings
		...
		w = COMPATF2_FLOORMOVE | COMPATF2_EXPLODE1 | COMPATF2_RESERVEDLINEFLAG | COMPATF2_OLD_RANDOM_GENERATOR;
		break;
	...
	case 2:	// same as 1 but stricter (NO_PASSMOBJ and INVISIBILITY are also set)
		...
		w = COMPATF2_BADANGLES | COMPATF2_FLOORMOVE | COMPATF2_POINTONLINE | COMPATF2_EXPLODE2 | COMPATF2_VOODOO_ZOMBIES | COMPATF2_EMULATEMIKOPORTALS | COMPATF2_RESERVEDLINEFLAG | COMPATF2_OLD_RANDOM_GENERATOR;
		break;
...
CVAR (Flag, compat_transfersecrets,		compatflags2, COMPATF2_TRANSFERSECRET);
